...
const RequestDetails = ({ request }: RequestPageProps) => {
  ...
  return (
    <div>
      ...
      <div className="flex">
        <div className="relative z-10 flex items-center w-full xl:w-1/2 my-5 xl:my-0">
          <div className="max-w-2xl mt-5 shadow-xl bg-white/90 p-5 rounded-md">
              ...
              {user?.role === "tenant" ? (
                <div className="">
                  <Button
                    ...
                    className="w-full cursor-pointer flex gap-2 justify-center items-center border hover:bg-transparent hover:text-black"
                  >
...
const DetailCard = ({
  ...
  <div className={` p-4 flex gap-4 ${fullSpan ? "col-span-2" : ""}`}>
